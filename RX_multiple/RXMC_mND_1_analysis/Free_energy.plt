...
set xrange [ 0.000500000 : 2.00000 ] noreverse writeback
...
plot "Free_energy_1.dat" using 1:2:4 w err ps 3 lw 2 title "Method 1 (exp(bH))", "Free_energy_2.dat" using ($1*1.001):4:6 w err ps 3 lw 2 title "Method 2 (exp(-dbH))"
#    EOF
