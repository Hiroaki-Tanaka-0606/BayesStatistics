...
GNUTERM = "wxt"
## Last datafile plotted: "State_mND.dat"
plot "State_mND.dat" using 0:1 w l title "mu[0]", "State_mND.dat" using 0:2 w l title "mu[1]", "State_mND.dat" using 0:3 w l title "a[1]"
#    EOF
